...
/**
 * {@link CrazyStreams} is an exercise class. Each method represent some
 * operation with a collection of accounts that
 * should be implemented using Stream API. Every method that is not implemented
 * yet throws
...
public class CrazyStreams {
     ...
     * Map has two keys {@code true} indicates
     ...
     * key is {@link String} which is an
     * email domain like "gmail.com". And the value is a {@link List} of
     * {@link Account} objects with a specific email domain.
     *
     ...
     * balances by its emails into a {@link Map}.
     ...
     * {@link Set} that contains first names
     ...
     * {@link String} that stores comma and space
     * -separated first names (e.g. "Polly, Dylan, Clark"), of all accounts that
     ...
     * {@link Account#creationDate}, and value is total balance
    ...
    /**
     * Returns a {@link Map} where key is a letter {@link Character}, and value is a
     * number of its occurrences ignoring
     * case, in all {@link Account#firstName} and {@link Account#lastName} that are
     * equal or longer than nameLengthBound.
