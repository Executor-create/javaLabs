...
/**
 * {@link CrazyOptionals} is an exercise class. Each method represents some
 * operation with a {@link Account} and
 * should be implemented using Optional API. Every method that is not
 * implemented yet throws
 * {@link ExerciseNotCompletedException}.
 * <p>
 * TODO: remove exception and implement each method of this class using Optional
 * API
 * <p>
 * <p>
...
public class CrazyOptionals {
    ...
    /**
     * Returns the {@link Account} got from {@link AccountProvider}. If account
     * provider does not provide an account,
    ...
    /**
     * Passes account to {@link AccountService#processAccount(Account)} when account
     * is provided.
    ...
    /**
     * Returns account provided by {@link AccountProvider}. If no account is
     * provided it generates one using {@link Accounts}
    ...
    /**
     * Returns an {@link Account} provided by {@link AccountProvider}. If no account
     * is provided,
    ...
    /**
     * Retrieves account using {@link AccountProvider} and fallbackProvider. In case
     * main provider does not provide an
     * {@link Account} then account should ge retrieved from fallbackProvider. In
     * case both provider returns no account
